...
CMD=$CMD' -o '$CORE_PATH'/'$PROJECT'/INDEL/RELEASE/FILTERED_ON_TARGET/'$SM_TAG'_MS_OnTarget_INDEL.vcf'

END_SAMPLE_PASS_TARGET_INDEL=`date '+%s'`

HOSTNAME=`hostname`

echo $PROJECT",L01,SAMPLE_PASS_TARGET_INDEL,"$HOSTNAME","$START_SAMPLE_PASS_TARGET_INDEL","$END_SAMPLE_PASS_TARGET_INDEL \
