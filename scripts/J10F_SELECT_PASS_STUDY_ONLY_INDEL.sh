...
CMD=$CMD' -o '$CORE_PATH'/'$IN_PROJECT'/MULTI_SAMPLE/VARIANT_SUMMARY_STAT_VCF/'$PREFIX'.BEDsuperset.VQSR.INDEL.STUDY.SAMPLES.PASS.vcf'

END_STUDY_INDELS_PASS=`date '+%s'`

HOSTNAME=`hostname`

echo $IN_PROJECT",J01,STUDY_INDELS_PASS,"$HOSTNAME","$START_STUDY_INDELS_PASS","$END_STUDY_INDELS_PASS \
