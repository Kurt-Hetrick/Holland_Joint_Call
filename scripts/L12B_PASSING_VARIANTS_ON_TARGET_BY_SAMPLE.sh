...
CMD=$CMD' -o '$CORE_PATH'/'$PROJECT'/VCF/RELEASE/FILTERED_ON_TARGET/'$SM_TAG'_MS_OnTarget.vcf'

END_SAMPLE_PASS_TARGET_VARIANT=`date '+%s'`

HOSTNAME=`hostname`

echo $PROJECT",L01,SAMPLE_PASS_TARGET_VARIANT,"$HOSTNAME","$START_SAMPLE_PASS_TARGET_VARIANT","$END_SAMPLE_PASS_TARGET_VARIANT \
